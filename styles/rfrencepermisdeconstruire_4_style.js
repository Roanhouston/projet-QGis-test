var size = 0;
var placement = 'point';
function categories_rfrencepermisdeconstruire_4(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'En cours':
...
var style_rfrencepermisdeconstruire_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Achèvemen");
    var labelText = "";
    size = 0;
...
var style = categories_rfrencepermisdeconstruire_4(feature, value, size, resolution, labelText,
