...
map.getView().fit([632888.061238, 6849232.477016, 633128.542930, 6849388.863883], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte dynamique de la commune de Châteaufort (78)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (70 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Carte dynamique permettant d\'établir la mise à jour du plan cadastrale';
            }
